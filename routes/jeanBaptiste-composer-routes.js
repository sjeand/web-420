/*
=======================================================
  Title: jeanBaptiste-composer-routes.js
...
const Composer = require("../models/jeanBaptiste-composer.js");
 ...
 */
 router.delete('/composers/:id', async (req, res) => {
    try {
        const composersDocId = req.params.id;

        Composer.findByIdAndDelete({'_id': composersDocId}, function(err, composer) {
            if (err) {
                console.log(err);
                res.status(501).send({
                    'message': `MongoDB Exception: ${err}`
